...
def ParseVisualOrders(visualOrdersElementsList):
...
visualOrderElementsList = SeperateVSIndicatorVisualOrders(preprocessedVS_IndicatorFileLines)

# parse seperated Visual Orders
parsedVSIndicatorVisualOrders = ParseVisualOrders(visualOrderElementsList)
